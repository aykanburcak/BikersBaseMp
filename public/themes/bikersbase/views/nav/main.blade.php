<nav class="navbar navbar-default navbar-main navbar-dark navbar-top">
  <div class="container">
    ...
    <ul class="nav navbar-nav navbar-right navbar-mob-left">
      ...
      @else
        <li><a href="#nav-login-dialog" data-toggle="modal" data-target="#loginModal"><span >{{ trans('theme.sing_in') }}</span></a></li>
      @endauth
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          <a href="{{ route('categories') }}" id="dLabel" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            </span>{{ trans('nav.categories') }}<i class="dropdown-caret"></i>
          </a>
        ...
        @foreach($featured_categories as $featured_category)
          <li class="dropdown">
            <a class="navbar-item" href="{{ route('category.browse', $featured_category->slug) }}">{{ $featured_category->name }}</a>
          </li>
        @endforeach
        {{--
        <li class="dropdown">
          <a class="navbar-item" href="{{ route('shop.giftCard') }}">{{ trans('theme.gift_cards') }}</a>
        </li> --}}
        <li class="dropdown">
          <a class="navbar-item" href="{{ url('/selling') }}">{{ trans('theme.nav.sell_on', ['platform' => get_platform_title()]) }}</a>
        </li>
      </ul>
