				  	...
				  	<div class="col-md-7 col-sm-6 nopadding">
				      	<div class="product-single">
                            ...
                            <div class="row gutter-5">
                                <div class="col-xs-6">
                                    <a href="{{ route('direct.checkout', $item->slug) }}" class="btn btn-lg btn-warning flat" id="buy-now-btn">
					            ...
					            <div class="product-widget">
					                ...
					                <div class="btn-group text-center">
				                        <a class="btn btn-default btn-xs flat itemQuickView" href="{{ route('quickView.product', $linkedItem->slug) }}">
							          	...
							          	<a data-link="{{ route('cart.addItem', $linkedItem->slug) }}" class="btn btn-primary btn-xs flat sc-add-to-cart">
